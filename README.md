...
//TEST isFourColumnField
						...
						headerRowFields.each(function (index) {
							...
							const fieldWrapper = $('<div class="inline-header-block" style="width:350px"></div>');
							...
							if (index < 4) {
								...
								const inputElem = $('<input type="text" class="inline-input" style="width:350px;height:35px;border-radius:10px;border-width: thin;margin-bottom:2px;padding-bottom:2px" placeholder="' + labelText + '" />');
...
wrapErrorRows();
	...
	const sections = [
		...
		{ id: 'undertakings', number: 5, title: 'Undertakings', tickId: 'tick5', numberId: 'number5', divid: '5_div' },
		{ id: 'DocumentsUpload', number: 6, title: 'Documents Upload', tickId: 'tick6', numberId: 'number6', divid: '6_div' },
		{ id: 'CommunicationTab', number: 7, title: 'Communication', tickId: 'tick7', numberId: 'number7', divid: '7_div' }
